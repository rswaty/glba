...
---
This is an initial exploration of LANDFIRE data for the Great Lakes Basin Assessment.  All maps and charts will likely change based on data needs, boundary outline decisions and use of different/additional attributes. 
...
CDL members donated their time to complete this web app for the SRFSN. Projects like these provide real-life opportunities to apply new techniques to answer common natural resource questions. A big thanks to [Myles Walimaa](https://mwalimaa.github.io/portfolio/){target="blank"} for GIS processing R code. 
